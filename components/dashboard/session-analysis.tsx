            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip 
                  ...
                  labelFormatter={(value) => `${value} (${sessionErrorRateData[Number(value.split(' ')[1]) - 1]?.date})`}
                />
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip 
                  ...
                  labelFormatter={(value) => `${value} (${sessionWordsData[Number(value.split(' ')[1]) - 1]?.date})`}
                />
                <Legend />
                <Bar dataKey="total" fill="hsl(var(--chart-3))" name="Total Words" />
                <Bar dataKey="errors" fill="hsl(var(--chart-1))" name="Error Words" />
                <Bar dataKey="corrected" fill="hsl(var(--chart-2))" name="Corrected Words" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip 
                  formatter={(value) => [`${Number(value).toFixed(1)}%`, 'Error Rate']}
                  labelFormatter={(value) => `${value} (${errorRateTrendData[Number(value.split(' ')[1]) - 1]?.date})`}
                />
                <Line type="monotone" dataKey="errorRate" stroke="hsl(var(--chart-4))" activeDot={{ r: 8 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
